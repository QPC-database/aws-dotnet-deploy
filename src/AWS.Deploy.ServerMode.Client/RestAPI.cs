...
namespace AWS.Deploy.ServerMode.Client
{
    ...
    public partial interface IRestAPIClient
    {
        ...
        /// <summary>Gets a summary of the Recipe for the session's project.</summary>
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<RecipeSummary> GetRecipeAsync(string sessionId, string recipeId);
    
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <summary>Gets a summary of the Recipe for the session's project.</summary>
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<RecipeSummary> GetRecipeAsync(string sessionId, string recipeId, System.Threading.CancellationToken cancellationToken);
    ...
    public partial class RestAPIClient : IRestAPIClient
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<RecipeSummary> GetRecipeAsync(string sessionId, string recipeId)
        {
            return GetRecipeAsync(sessionId, recipeId, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<RecipeSummary> GetRecipeAsync(string sessionId, string recipeId, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/v1/Deployment/session/<sessionId>/recipe/<recipeId>?");
            if (sessionId != null)
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("sessionId") + "=").Append(System.Uri.EscapeDataString(ConvertToString(sessionId, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
