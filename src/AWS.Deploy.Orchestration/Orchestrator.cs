    ...
    public class Orchestrator
    {
        ...
        public async Task<List<Recommendation>> GenerateDeploymentRecommendations(bool forDeployment = true)
        {
            if (_recipeDefinitionPaths == null)
                throw new InvalidOrchestratorException($"{nameof(_recipeDefinitionPaths)} is null as part of the orchestartor object");
            if (_session == null)
                throw new InvalidOrchestratorException($"{nameof(_session)} is null as part of the orchestartor object");
        ...
        public async Task<Dictionary<string, string>> GetReplacements()
        {
            ...
            if (_awsResourceQueryer == null)
                throw new InvalidOrchestratorException($"{nameof(_awsResourceQueryer)} is null as part of the Orchestrator object");
        ...
        public async Task DeployRecommendation(CloudApplication cloudApplication, Recommendation recommendation)
        {
            if (_interactiveService == null)
                throw new InvalidOrchestratorException($"{nameof(_interactiveService)} is null as part of the orchestartor object");
            if (_cdkManager == null)
                throw new InvalidOrchestratorException($"{nameof(_cdkManager)} is null as part of the orchestartor object");
            if (_cdkProjectHandler == null)
                throw new InvalidOrchestratorException($"{nameof(_cdkProjectHandler)} is null as part of the orchestartor object");
            if (_session == null)
                throw new InvalidOrchestratorException($"{nameof(_session)} is null as part of the orchestartor object");
        ...
        public async Task<bool> CreateContainerDeploymentBundle(CloudApplication cloudApplication, Recommendation recommendation)
        {
            ...
            if (_dockerEngine == null)
                throw new InvalidOrchestratorException($"{nameof(_dockerEngine)} is null as part of the orchestartor object");
            if (_deploymentBundleHandler == null)
                throw new InvalidOrchestratorException($"{nameof(_deploymentBundleHandler)} is null as part of the orchestartor object");
